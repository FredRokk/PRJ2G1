...
int main(int argc, char *argv[])
{
    ...
    versus wVersus;
    results wResults;
    playerOneHighscore wPlayerOneHighscore;
    playerTwoHighscore wPlayerTwoHighscore;
    ...
    wPlayerOneHighscore.centralWidget()->findChild<QLabel*>("char1")->setText("C");
    wPlayerOneHighscore.centralWidget()->findChild<QLabel*>("char2")->setText("A");
    wPlayerOneHighscore.centralWidget()->findChild<QLabel*>("char3")->setText("T");
    ...
    wVersus.show();
    wResults.show();
    wPlayerOneHighscore.show();
    wPlayerTwoHighscore.show();
